...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Rohan\OneDrive\Desktop\Testing\program_images\bgReg.jpg")
    ...
    def reg(self):
        if (self.var_fname.get()=="" or self.var_lname.get()=="" or self.var_cnum.get()=="" or self.var_email.get()=="" or self.var_ssq.get()=="Select" or self.var_sa.get()=="" or self.var_pwd.get()=="" or self.var_cpwd.get()==""):
            ...
            try:
                conn = mysql.connector.connect(user='root', password='root', host='localhost', database='student_data', port=3306)
